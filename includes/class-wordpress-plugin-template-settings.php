...
class WordPress_Plugin_Template_Settings {
	...
	public function add_menu_item () {
		$page = add_options_page( __( 'Plugin Settings', 'wordpress-plugin-template' ) , __( 'As Comments Settings', 'wordpress-plugin-template' ) , 'manage_options' , $this->parent->_token . '_settings' ,  array( $this, 'settings_page' ) );
	...
	private function settings_fields () {
		...
		$postTypeOptions = get_post_types();

		$postTypeOptions = array_merge($postTypeOptions, array('all'=>'all')); 		// add 'all' as an option

		function modify($str) {
			return ucwords(str_replace("_", " ", $str));	// Uppercase and replace '_' with space(' ')
		}

		$postTypeOptions = array_map('modify', $postTypeOptions);
